...
const { workingfine, googleProfile, userGoogleLogin, loginfarmerLocal, registerfarmerLocal, loginUser, registerUser, loginSuccess } = require('../controllers/authController');
