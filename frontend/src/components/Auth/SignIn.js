          ...
          <div>
            ...
            <div className="mb-10">
              <button
                ...
                className="bordder-primary w-full cursor-pointer rounded-md border bg-blue-600 py-3 px-5 text-base text-white transition duration-300 ease-in-out hover:shadow-md"
              >Sign In</button>
            </div>
          </div>
